...
import { LayoutDashboard, Kanban, Users, ClipboardList, Handshake, Building2, FileText, BarChart3 } from "lucide-react";
import { createClient } from "@/lib/supabase/server";
import { DashboardShell } from "@/components/shared/dashboard-shell";

const NAV = [
  { label: "Overview", href: "/admin", icon: <LayoutDashboard className="h-4 w-4" strokeWidth={1.75} /> },
  { label: "Pipeline", href: "/admin/pipeline", icon: <Kanban className="h-4 w-4" strokeWidth={1.75} /> },
  { label: "Reports", href: "/admin/reports", icon: <BarChart3 className="h-4 w-4" strokeWidth={1.75} /> },
